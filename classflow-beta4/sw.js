const CACHE='classflow-beta4-shell-v1';
const ASSETS=['./','./index.html','./beta4.css','./courses-v1.js','./manifest.json','../classflow/icon.svg','../classflow-beta3/beta3.css','../classflow-beta3/app.js','../classflow-beta3/review-clean-v2.js'];
