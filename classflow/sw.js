const CACHE='classflow-shell-1-03-004';
const ASSETS=['./','./index.html','./style.css?v=1.03.004','./app.js?v=1.03.004','./courses.js?v=1.03.004','./manifest.json','./classflow-logo-v4.png'];
