const CACHE='classflow-shell-v10';
const ASSETS=['./','./index.html','./style.css','./layout-fix.css','./hierarchy-fix.css','./interaction-fix.css','./ui-hotfix.js','./app.js','./manifest.json','./icon.svg'];
