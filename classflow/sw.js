const CACHE='classflow-shell-1-03-008';
const ASSETS=['./','./index.html','./style.css?v=1.03.008','./app.js?v=1.03.008','./courses.js?v=1.03.008','./manifest.json','./classflow-logo-v4.png'];
