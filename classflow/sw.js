const CACHE='classflow-shell-1-03-010';
const ASSETS=['./','./index.html','./style.css?v=1.03.010','./app.js?v=1.03.010','./courses.js?v=1.03.010','./manifest.json','./classflow-logo-v4.png'];
