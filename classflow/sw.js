const CACHE='classflow-shell-1-03-009';
const ASSETS=['./','./index.html','./style.css?v=1.03.009','./app.js?v=1.03.009','./courses.js?v=1.03.009','./manifest.json','./classflow-logo-v4.png'];
