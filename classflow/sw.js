const CACHE='classflow-shell-v13';
const ASSETS=['./','./index.html','./style.css','./layout-fix.css','./hierarchy-fix.css','./interaction-fix.css','./local-v13.js','./manifest.json','./icon.svg'];
