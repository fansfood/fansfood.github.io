const CACHE='classflow-shell-1-03-003';
const ASSETS=['./','./index.html','./style.css?v=1.03.003','./app.js?v=1.03.003','./courses.js?v=1.03.003','./manifest.json','./classflow-logo-v4.png'];
