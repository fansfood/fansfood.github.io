const CACHE='classflow-shell-v3-2-1';
const ASSETS=['./','./index.html','./manifest.json','./icon.svg','../classflow-beta3/beta3.css?v=2','../classflow-beta3/app.js?v=2','../classflow-beta3/review-clean-v2.js?v=2'];
