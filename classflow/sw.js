const CACHE='classflow-shell-v4-0-3-1';
const ASSETS=['./','./index.html','./base.css','./courses.css','./app.js','./review-clean-v2.js','./courses-v1.js','./stable-shell.js','./manifest.json','./icon.png'];
