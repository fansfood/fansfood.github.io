...
function patchStableLabels(){
  document.title='ClassFlow 1.03.003 · 实时课堂翻译'
  const status=$('status')
  if(status&&/BETA 3|Beta 3|BETA 4|Beta 4/i.test(status.textContent))status.textContent='ClassFlow 1.03.003 · Course → Lesson / 课程分层'
