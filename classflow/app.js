...
async function enterApp(session){
  ...
  setStatus('ClassFlow 1.03.010 · 翻译优先 / Translation first');render();loadHistory();checkProviders();if(state.sessionId)loadRecordings();retryPendingUploads()
}
...
if('serviceWorker' in navigator)navigator.serviceWorker.register('./sw.js?v=1.03.010').catch(()=>{})
