const CACHE='classflow-beta-shell-v13';
const ASSETS=['./','./index.html','./manifest.json','./local-v13.js','../classflow/icon.svg','../classflow/style.css','../classflow/layout-fix.css','../classflow/hierarchy-fix.css','../classflow/interaction-fix.css'];
