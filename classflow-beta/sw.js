const CACHE='classflow-beta-shell-v12';
const ASSETS=['./','./index.html','./manifest.json','./local-v12.js','../classflow/icon.svg','../classflow/style.css','../classflow/layout-fix.css','../classflow/hierarchy-fix.css','../classflow/interaction-fix.css'];
