const CACHE='classflow-beta-shell-v10';
const ASSETS=['./','./index.html','./manifest.json','./priority-v10.js','../classflow/icon.svg','../classflow/style.css','../classflow/layout-fix.css','../classflow/hierarchy-fix.css','../classflow/interaction-fix.css','../classflow/app.js','../classflow/ui-hotfix.js'];
